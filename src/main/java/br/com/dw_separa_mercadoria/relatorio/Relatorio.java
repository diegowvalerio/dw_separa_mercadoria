package br.com.dw_separa_mercadoria.relatorio;
...
public class Relatorio{
	...
	/*venda ano mes*/
	public void recibo_horaextra(Integer idfechamento){
		try{
			String caminho = "";
			caminho = Faces.getRealPath("/pages/relatorios/fechamento/recibo_horaextra");
	...
	private Connection getConexao(){
		try {
			...
			con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/dwerp", "postgres", "postgres");
